...
tmux selectp -t 1
tmux send-keys "sleep 1;rosparam set use_sim_time true" C-m
tmux selectp -t 2
tmux send-keys "sleep 1;rosbag play /home/luyifan/ROS_BAG/zizhu-2018-08-30/2018-08-30-15-59-12.bag --clock -r 2.0 -s 0" C-m
tmux selectp -t 3
